...
\newcommand{\GBulktoWWtolnuqqbarpr}{\ensuremath{\GBulk\to\Wtolnuqqbarpr}\xspace} % Gbulk->WW->lnuqqbar'
...
\newcommand{\RadtoWWlnuqqbarpr}{\ensuremath{\Rad\to\WWtolnuqqbarpr}\xspace} % Rad->WW->lnuqqbar'
...
\newcommand{\MVV}{\ensuremath{m_\mathrm{diboson}}\xspace} % Diboson mass
...
\newcommand{\Dy}{\ensuremath{\Delta y_\mathrm{diboson}}\xspace} % DeltaY
