...
\newcommand{\ZprtoZH}{\ensuremath{Z'\to ZH}\xspace} % Z'->ZH
...
\newcommand{\ptthresh}{\ensuremath{p_\mathrm{T,thresh}}\xspace} % Transverse momentum threshold
...
\newcommand{\ptmiss}{\ensuremath{\pt^\mathrm{miss}}\xspace} % Missing transverse energy
\newcommand{\ptmissTI}{\ensuremath{\pqty{\ptmiss}^\mathrm{Type-I}}\xspace} % Type-I corrected missing transverse energy
\newcommand{\MVV}{\ensuremath{m_{\WV/\WH}}\xspace} % Diboson mass
\newcommand{\MVVpart}{\ensuremath{m_{\WV/\WH}^\mathrm{part}}\xspace} % Partially simulated diboson mass
...
\newcommand{\DetaVBF}{\ensuremath{\Delta\eta_\mathrm{VBF}}\xspace} % DeltaEta dijet
\newcommand{\mjjVBF}{\ensuremath{m_\mathrm{jj}^\mathrm{VBF}}\xspace} % VBF dijet mass
\newcommand{\nJets}{\ensuremath{N_\mathrm{jets}}\xspace} % Number of jets
\newcommand{\Dy}{\ensuremath{\Delta y_{\WV/\WH}}\xspace} % DeltaY
\newcommand{\DoubleB}{\ensuremath{\mathrm{DoubleB}}\xspace} % DoubleB tagger
\newcommand{\PVV}{\ensuremath{P_{\WV/\WH}}\xspace} % 2D conditional template
\newcommand{\PJ}{\ensuremath{P_\mathrm{jet}}\xspace} % 1D jet mass template
