...
\begin{itemize}
  ...
  \begin{table}[htbp]
    \centering
    \input{tab/analysis/data2017Samples.tex}
    \caption{
  ...
  \begin{table}[htbp]
    \centering
    \input{tab/analysis/data2018Samples.tex}
    \caption{
...
\begin{table}[htbp]
  \centering
  \input{tab/analysis/ggFGBulkToWWSamples.tex}
  \caption{
    %
  }
...
\begin{table}[htbp]
  \centering
  \input{tab/analysis/VBFGBulkToWWSamples.tex}
  \caption{
    %
  }
...
\begin{table}[htbp]
  \centering
  \input{tab/analysis/ggFRadToWWSamples.tex}
  \caption{
    %
  }
...
\begin{table}[htbp]
  \centering
  \input{tab/analysis/VBFRadToWWSamples.tex}
  \caption{
    %
  }
...
\begin{table}[htbp]
  \centering
  \input{tab/analysis/DYWprToWZSamples.tex}
  \caption{
    %
  }
...
\begin{table}[htbp]
  \centering
  \input{tab/analysis/VBFWprToWZSamples.tex}
  \caption{
    %
  }
...
\begin{table}[htbp]
  \centering
  \input{tab/analysis/DYWprToWHSamples.tex}
  \caption{
    %
  }
...
\begin{table}[htbp]
  \centering
  \input{tab/analysis/VBFWprToWHSamples.tex}
  \caption{
    %
  }
...
\begin{table}[htbp]
  \centering
  \input{tab/analysis/DYZprToWWSamples.tex}
  \caption{
    %
  }
...
\begin{table}[htbp]
  \centering
  \input{tab/analysis/VBFZprToWWSamples.tex}
  \caption{
    %
  }
