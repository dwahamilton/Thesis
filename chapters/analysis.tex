...
\begin{table}[htbp]
  \centering
  \input{tab/analysis/triggers2016.tex}
  \caption{
...
\begin{table}[htbp]
  \centering
  \input{tab/analysis/triggers2017.tex}
  \caption{
...
\begin{table}[htbp]
  \centering
  \input{tab/analysis/HEEPV70.tex}
  \caption{
...
\begin{table}[htbp]
  \centering
  \input{tab/analysis/VTagFactors.tex}
  \caption{
...
\begin{table}[htbp]
  \centering
  \input{tab/analysis/VScaleRes.tex}
  \caption{
