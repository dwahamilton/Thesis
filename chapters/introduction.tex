...
While Planck had no explanation for why the energy came in discrete packets, Einstein took this notion a step further in 1905 by instead insisting that the electromagnetic field itself was quantized, and that the discrete packets were in fact particles, which we now know as photons (denoted by the symbol $\gamma$). % Citation
In addition to explaining the observed behavior of the black body power spectrum, Einstein's theory also provided an explanation for the photoelectric effect, for which he eventually received the 1921 Nobel Prize in Physics. % Citation
...
Eventually this issue of categorizing the new particles was resolved in 1964 with the development of the quark model by Murray Gell-Mann and George Zweig, who proposed that hadrons (i.e., baryons and mesons) are all composite and made up of elementary particles called quarks. % Citation
...
Then in 1974, the discovery of the $J$/$\psi$ meson by C.\ C.\ Ting at Brookhaven National lab and Burton Richter at the Stanford Linear Accelerator Facility would give further evidence for the quark model, as it turned out to be a bound state of a new quark---called the charm quark ($c$)---and its antiquark. % Citations
Later experiments in the following years would also produce baryons with this new quark, along with a new lepton called the $\tau$ lepton, a neutrino associated with the $\tau$ called $\nu_\tau$, and a new quark called the bottom quark ($b$) after discovering the upsilon meson. % Citations
...
While this turned out to be true, the discovery of the sixth quark, known as the top quark ($t$), would not come until much later in 1995 at the Tevatron. % Citation
...
In 1967, Steven Weinberg's work on electroweak unification predicted the masses for the $W^\pm$ and $Z$ bosons, which turned out to be the mediators of the weak force. % Citation
His work, along with Sheldon Glashow and Abdus Salam, would lead to the three being awarded the 1979 Nobel Prize in Physics. % Citation
The discovery of the $W$ and $Z$ bosons would then occur at CERN in 1983, with the observed masses falling well within the predicted ranges given by electroweak theory. % Citation
These crucial developments helped lead to widespread acceptance of the Standard Model of particle physics, and with the discovery of the top quark in 1995, the sub-atomic picture of matter was in a much tidier state than compared to the beginning of the 20th century: there are six quarks, six leptons, and four gauge bosons ($g$, $\gamma$, $W^\pm$, $Z$) that mediate the strong, weak, and electromagnetic interactions.

% Discovery of the Higgs
One particle predicted by the Standard Model still eluded experiment up to this point.
...
This required the existence of a new boson known as the Higgs, and despite the fact that the Higgs mechanism was developed during the formulation of the Standard Model in the 1960's, it would not be until much later that the particle itself was discovered. % Citation
After the discovery of the top quark, the Higgs would elude physicists for almost two decades before being discovered at CERN in 2012. % Citation
...
But despite all of its success over the last few decades, there are still longstanding issues in particle physics that the Standard Model is currently incapable of addressing.
While it describes the strong, weak, and electromagnetic interactions very well at the energy scales present experiments have access to, one major shortcoming of the Standard Model is that it does not include gravitational interactions, and efforts to formulate a quantum theory of gravity are still ongoing.
Another issue is that the baryonic matter that the Standard Model describes only makes up about 5\% of the observed universe, while 27\% is dark matter, and the remaining 68\% is dark energy---neither of which the Standard Model accounts for. % Citation
