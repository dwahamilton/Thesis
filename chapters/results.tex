...
%    \frac{\mathcal{L}(\mu,\hat{\hat{\vb*{\vb*{\theta}}}}(\mu))}{\mathcal{L}(\hat{\mu},\hat{\vb*{\vb*{\theta}}})} & \hat{\mu}\geq0,\\
%    \frac{\mathcal{L}(\mu,\hat{\hat{\vb*{\vb*{\theta}}}}(\mu))}{\mathcal{L}(0,\hat{\hat{\vb*{\vb*{\theta}}}}(0))} & \hat{\mu}<0,
%  \end{cases}
%\end{equation}
%with $\hat{\hat{\vb*{\vb*{\theta}}}}$ corresponding to the conditional maximum likelihood estimators of $\vb*{\vb*{\theta}}$.
