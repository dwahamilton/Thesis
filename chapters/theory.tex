...
The decays of interest are \XtoWV and \XtoWH, where $V=W,Z$ is any of the two massive electroweak vector bosons and $H$ is the Higgs boson discovered at the LHC in 2012.
...
Furthermore, the semileptonic final state is also a good compromise for search sensitivity since it is cleaner than an all-hadronic final state, and produces more expected signal than an all-leptonic state.
