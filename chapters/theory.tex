...
In the absence of some mechanism that resolves this issue, we are left with having to fine-tune parameters of the Standard Model in order to resolve the hierarchy problem.
...
We consider semileptonic final event states in which the $W$ decays leptonically via \Wtolnu, as this provides a clean experimental signature and an efficient online event selection.
