...
%    For the quartic electroweak vertex, the two particles interacting with the $W^\pm$'s must be chosen such that charge conservation holds.
%  }
%  \label{fig:SMVert}
%\end{figure}
...
\begin{enumerate}
  \item \textbf{Spin-0 Kaluza-Klein Radion:} A neutral scalar boson appearing in RS models that can decay to the vector bosons $W^\pm$ and $Z$ via \RadtoWW and \RadtoZZ~\cite{Goldberger_1999,Goldberger_2000}.
  \item \textbf{Spin-1 \Wpr/\Zpr Boson:} A heavier version of the spin-1 $W^\pm$ and $Z$ bosons that can decay via \WprtoWZ, \WprtoWH, \ZprtoWW, and \ZprtoZH~\cite{Pappadopulo_2014}.
