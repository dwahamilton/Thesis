...
%In the case of figure~\ref{fig:impacts_WprToWH}, these tend to be the bb categories since the signal results in a \WH resonance, while for figure~\ref{fig:impacts_VBFRadToWW} they tend to be vbf categories since it is a \VBF signal.
