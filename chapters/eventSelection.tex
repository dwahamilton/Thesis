...
For each year we use different paths, which are listed in table~\ref{tab:triggers}.%~\ref{tab:triggers2016}, \ref{tab:triggers2017}, and \ref{tab:triggers2018} for the years Run 2, respectively.
