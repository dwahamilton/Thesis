...
The so-called $H\to ZZ^*\to 4\ell$ ``golden channel'' has the cleanest signal when all four of the leptons in the final state are muons. % Citation
...
Their fast time response is used in the trigger system in order to determine whether or not event data should be saved based on the measured muon momentum.
% Need figure of RPC
...
% Need figure of L1 Trigger architecture
