...
Linear accelerators operate on simpler design principles compared to circular accelerators, but have to be very long in order to reach high center-of-mass energies.

% Circular accelerators
On the other hand, circular accelerators accelerate particles along a circular trajectory using electromagnets. % Citation
...
Furthermore, any charged particle with mass $m$ and charge $q$ moving in a circular trajectory radiates synchrotron radiation described by
\begin{equation}
...
Leptonic collisions also allow for more precise measurements because the initial state of the particles is well-defined, while hadron colliders require sophisticated techniques to reconstruct the initial state due to the fact that hadrons are composite.
